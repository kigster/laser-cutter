  ...
  module Cutter
    module Model
      describe Configuration do
        let(:config) { Laser::Cutter::Model::Configuration.new(opts.merge(file: '/tmp/box.pdf')) }
        ...
        context '#validate' do
          context 'missing options' do
            ...
            it 'should be able to validate missing options' do
              ...
              expect { config.validate! }.to raise_error(Laser::Cutter::Model::MissingOption)
            end
          end
          context 'zero options' do
            ...
            it 'should be able to validate missing options' do
              ...
              expect { config.validate! }.to raise_error(Laser::Cutter::Model::ZeroValueNotAllowed)
            end
          end
        end
